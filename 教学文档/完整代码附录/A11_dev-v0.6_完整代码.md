...
| `VERSION` | 10 | 1 | `edece302f05556b99cfb604b9a1db8f225dea36a7d356a7b5042ec9595166ead` |
| `app.py` | 17138 | 481 | `82cf0cefdf7f76a581e7173a345d4e1f72db0d44fe080146ba09dfb8b1bb0730` |
...
| `static/style.css` | 16004 | 983 | `64001531da988d6ff527fdaca0b10924251953101a6bfa3300dcb7e4e2f040ff` |
...
| `templates/base.html` | 3163 | 69 | `7162ab3dd857a038d7d4d4235c4d0140db7bae9b3db4dad249364fe97a263050` |
...
| `templates/index.html` | 3027 | 66 | `136ba441f673d779b3444de2764bfcdf148e2a508dc2272c32ed14e60d648b45` |
...
| `tests/test_app.py` | 10523 | 323 | `fd318c882644de8179c2c716b8b225e337d358f49915f227d193a9ece337548a` |
    ...
    <div class="container hero-grid">
        <div>
            ...
            <p class="hero-copy">
                ...
                本版本在完整业务流程上补齐安全校验、异常页面和自动测试，让系统不仅能用，而且更可靠。
            </p>
        ...
        <div class="prototype-card">
            ...
            <p>正常路径和错误路径都被验证，表单写操作也加入会话防伪保护。</p>
            <ul class="check-list">
                <li>校验逻辑从路由中独立出来</li>
                <li>所有POST表单验证防伪令牌</li>
                <li>错误请求显示友好的说明页面</li>
                <li>自动测试覆盖正常与异常流程</li>
            </ul>
        </div>
