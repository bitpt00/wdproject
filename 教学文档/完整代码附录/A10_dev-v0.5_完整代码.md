...
| `VERSION` | 10 | 1 | `4f71adcb5fb6e3e3ed67098ba83f1063e005d7a75bc203c737349462c159ee85` |
| `app.py` | 16354 | 468 | `aaa88fac6e8716232b8bec644511565d9fbb21321b05ab14acc62fcd9fbd3cea` |
...
| `static/style.css` | 15420 | 949 | `f66299b53d8cac6752bc5c273b038b444080a66e29b64c3926f099c6f161c3e0` |
| `templates/approval_detail.html` | 3095 | 63 | `6ff44dd8844a406216f5428cf4f43e9c8e9e91366a300b2d56a52c128fb8ec1f` |
| `templates/approvals.html` | 2247 | 43 | `35d470bffdf5d85226f4318e0d8efd0dd931ac4f3a47196e1fbc060a1e9361c6` |
| `templates/base.html` | 3071 | 68 | `b636ef899a15e365e299ebdf5cb99a8ec953abb940871d5b6e5606e03be9216c` |
| `templates/booking_detail.html` | 2974 | 57 | `e78114412ea88c46dc39bbf7a6de0f6a0d6233c69c67ee210ad314abbe28bf5b` |
| `templates/dashboard.html` | 2305 | 52 | `71402a12e24b8153873056bbe1275e9cfdeb2fcb46a71924fd87c9826fd74c8a` |
| `templates/index.html` | 3017 | 66 | `bb0319387a2466c1ac77adae5dfc812cf6ec122f26a3c765d23cd5d27180745b` |
...
| `tests/test_app.py` | 9183 | 284 | `ec4835bda561873875826671b6a683fbdab954ffce2731ec163a4a6fd6efe7f3` |
...
<section class="section compact-top">
    <div class="container dashboard-grid">
        ...
        <aside class="stage-panel">
            <span class="prototype-label">dev-v0.5观察点</span>
            <h2>状态如何发生变化</h2>
            <p>预约从待审批变为已通过、已驳回或已取消；每次变化同时写入状态历史，记录操作者和意见。</p>
        </aside>
    </div>
</section>
{% endblock %}
    ...
    <div class="container hero-grid">
        <div>
            ...
            <p class="hero-copy">
                ...
                本版本连接学生申请与教师审批，预约从提交、通过或驳回到结果查询形成完整流程。
            </p>
        ...
        <div class="prototype-card">
            ...
            <p>同一条预约在不同角色之间流转，每次状态变化都会留下历史记录。</p>
            <ul class="check-list">
                <li>学生提交后进入待审批队列</li>
                <li>审批教师查看完整申请内容</li>
                <li>教师通过或填写原因后驳回</li>
    ...
    <div class="container">
        ...
        <div class="feature-grid">
            ...
            <article class="feature-card">
                ...
                <span class="state available">申请与审批已贯通</span>
            </article>
        </div>
    </div>
</section>
